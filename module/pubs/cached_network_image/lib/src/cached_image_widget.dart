...
class CachedNetworkImage extends StatelessWidget {
  /// Get the current log level of the storage manager.
  static CacheManagerLogLevel get logLevel => CacheManager.logLevel;

  /// Set the log level of the storage manager to a [CacheManagerLogLevel].
  ...
  /// [url] is used by both the disk and memory storage. The scale is only used
  ...
  /// The target image's storage key.
  ...
  /// Will resize the image and store the resized image in the disk storage.
