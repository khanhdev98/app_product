...
class ImageLoader implements platform.ImageLoader {
  ...
  Stream<ui.Codec> loadAsync(
    ...
    try {
      ...
      // Depending on where the exception was thrown, the image storage may not
      // have had a chance to track the key in the storage at all.
      // Schedule a microtask to give the storage a chance to add the key.
      scheduleMicrotask(() {
        evictImage();
      });
