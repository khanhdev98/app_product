...
class _ModalBottomSheetState<T> extends State<_ModalBottomSheet<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final scrollController =
        PrimaryScrollController.of(context) ?? (_scrollController ??= ScrollController());
...
Future<T?> showCustomModalBottomSheet<T>({
  ...
  final result =
      await Navigator.of(context, rootNavigator: useRootNavigator).push(ModalBottomSheetRoute<T>(
    builder: builder,
    bounce: bounce,
